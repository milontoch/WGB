    ...
    const order = await createOrder(
      {
        ...
        shipping_address: metadata.is_pickup ? null : (metadata.shipping_address || null),
        shipping_city: metadata.is_pickup ? null : (metadata.shipping_city || null),
        shipping_state: metadata.is_pickup ? null : (metadata.shipping_state || null),
        is_pickup: metadata.is_pickup === true || metadata.is_pickup === "true",
        notes: null,
      },
      cartItems
    );
